...
@Data
public class InstoragePreAudit extends BaseEntity {
    ...
    private Long afterAuditInStorageId;
    @Transient
    ...
    @Transient
    private Integer suppIsAudit;
    @Transient
    private String afterAuditInStorageNumber;
    @Transient
