...
//
    ...
    //============================采购退料============================
    @RequestMapping(value = "/k3cloud/stock/purchaseReturn/save", method = RequestMethod.POST)
    ResponseResult savePurchaseReturn(@RequestParam("acctId") String acctId,
                                      @RequestParam("dataCentreUserName") String dataCentreUserName,
                                      @RequestParam("dataCentrePassword") String dataCentrePassword,
                                      @RequestParam("fNumberStockOrg") String fNumberStockOrg, @RequestParam("fDate") String fDate,
                                      @RequestParam("fNumberBillType") String fNumberBillType, @RequestParam("fOwnerTypeIdHead") String fOwnerTypeIdHead,
                                      @RequestParam("fNumberOwnerIdHead") String fNumberOwnerIdHead, @RequestParam("fNumebrSupplierId") String fNumebrSupplierId,
                                      @RequestParam("fNumberPurchaseOrg") String fNumberPurchaseOrg, @RequestParam("fMrtype") String fMrtype,
                                      @RequestParam("fMrmode") String fMrmode, @RequestParam("fNumberRequireOrg") String fNumberRequireOrg,
                                      @RequestParam("fNumberSettleOrg") String fNumberSettleOrg, @RequestParam("fNumberSettleCurr") String fNumberSettleCurr,
                                      @RequestParam("fPriceTimepoint") String fPriceTimepoint, @RequestParam("purmrbEntryJson") String purmrbEntryJson,
                                      @RequestParam("fID") String fID, @RequestParam("fBillNo") String fBillNo);
